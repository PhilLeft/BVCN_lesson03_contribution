...
head(cell_assay)### shpw first 10 rows of data
...
There are several functions in R to deal with missing data
...
You need to use function `is.na` to determine which rows have missing data and then filter them out.
